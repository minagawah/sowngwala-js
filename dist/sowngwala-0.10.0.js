...
var ROUND_DIGITS = 100000;

/**
 * @param {number} num
 */
var round = num => Math.round(num * ROUND_DIGITS) / ROUND_DIGITS;
...
function _from_hms(h, m, s) {
  ...
  return Object.freeze({
    ...
    to_naive_time,
    calibrate,
    print: () => "".concat(_hour, "\xB0").concat(min, "'").concat(round(sec))
  });
  ...
  function calibrate(options) {
    ...
    var angle = !!(options !== null && options !== void 0 && options.angle);
    ...
    // into the positive.
    var hour_overflow = !!(options !== null && options !== void 0 && options.hour_overflow);
    ({
      hmsn: {
        hour: _hour,
        min,
...
;// CONCATENATED MODULE: ./src/coords/equatorial_from_ecliptic_with_generic_datetime.js
/**
...
;// CONCATENATED MODULE: ./src/sun/sun_pos_ecliptic_from_generic_date.js
/**
...
//# sourceMappingURL=sowngwala-0.10.0.js.map